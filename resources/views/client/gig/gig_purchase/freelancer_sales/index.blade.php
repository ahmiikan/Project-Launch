                                                    ...
                                                    <div class="wt-freelancerholder">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table-bordered table-striped">
                                                                ...
                                                                <tbody>
                                                                    @for($i = 0; $i < count($gigSales) && $i < count($gigs); $i++) 
                                                                        <tr>
                                                                            @if ($gigSales[$i]->purchase_status == 1)
                                                                                <td>{{ $a++ }}</td>
                                                                                
                                                                                <td>{{ $users[$i]->first_name }}</td>
                                                                                <td class="wt-title">{{ $gigs[$i]->title }}</td>
                                                                                <td >{{ $gigs[$i]->amount }}</td>
                                                                                <td >{{ $gigSales[$i]->created_at->addDays($gigs[$i]->duration)->format('Y-m-d H:i:s') }}</td>
                                                                                <td> In progress </td>
                                                                                <td>
                                                                                    <a  href="{{ route('gigSaleShow', $gigSales[$i]->id) }}"  class="btn btn-danger text-white btn-sm"><i class="lnr lnr-eye"></i> <span> view <span> </a>
                                                                                </td>
                                                                            @endif
                                                                        </tr>
                                                                    @endfor
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table-bordered table-striped">
                                                                ...
                                                                <tbody>
                                                                    @for($i = 0; $i < count($gigSales) && $i < count($gigs); $i++) 
                                                                    <tr>
                                                                        @if ($gigSales[$i]->purchase_status == 2)
                                                                            ...
                                                                            <td >{{ $gigSales[$i]->created_at->addDays($gigs[$i]->duration)->format('Y-m-d H:i:s') }}</td>
                                                                            <td >
                                                                                {{ $gigSales[$i]->gigDelivery[$i]->created_at->format('Y-m-d H:i:s')  }}
                                                                            </td>
                                                                            </td>
                                                                            <td >{{ $gigs[$i]->amount }}</td>
                                                                            <td>Delivered</td>
                                                                            <td>
                                                                                <a  href="{{ route('gigDeliveredShow', $gigSales[$i]->id) }}"  class="btn btn-danger text-white btn-sm"><i class="lnr lnr-eye"></i> <span> view <span> </a>
                                                                            </td>
                                                                        @endif
                                                                    </tr>
                                                                    @endfor
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table-bordered table-striped">
                                                                ...
                                                                <tbody>
                                                                    @for($i = 0; $i < count($gigSales) && $i < count($gigs); $i++) 
                                                                    <tr>
                                                                        @if ($gigSales[$i]->purchase_status == 3)
                                                                            ...
                                                                            <td>Completed</td>
                                                                            <td>
                                                                                <a  href="{{ route('gigCompletedShow', $gigSales[$i]->id) }}"  class="btn btn-danger text-white btn-sm"><i class="lnr lnr-eye"></i> <span> view <span> </a>
                                                                            </td>
                                                                        @endif
                                                                    </tr>
                                                                    @endfor
