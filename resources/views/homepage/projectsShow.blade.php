...
<head>
    ...
    <title>Projects - Project Launch</title>
...
<div class="mainContainer">
    <div class="mt-5">
        <div class="row">
            <h1 class="cardHeading col-sm-6">Our Latest Projects</h1>
                ...
                @if ($project->status == '1')
                    <div class="card-deck col-lg-4 mb-5">
                        <div class="card p-0 border-0">
                            <img class="card-img-top" src="{{asset('assets/images/sidebar/img-01.jpg') }}"
                                 alt="Card Image">
                            <div class="card-body">
                                <h4 class="card-title text-center cardHeading">{{ $project->title }}</h4>
                                ...
                                <table class="table table-striped mt-5 mb-5">
                                    ...
                                    <tr>
                                        <td>Attachment:</td>
                                        <td><a href="{{ route('downloadHomeProject', $project->attachment) }}">
                                                <i class="bi bi-paperclip cardIcons"></i>Download Attachment</a></td>
                                    </tr>
                                </table>
