...
<div class="mainContainer">
    <div class="mt-5">
        <h1 class="cardHeading m-4">Gig Detail</h1>
        <div class="row">
            @if ($gig->status == '1')
                <div class="card-deck col-lg-6 m-auto ">
...
<div class="d-flex flex-row-reverse w-75 m-auto">
    <p class=""><a href="{{ url()->previous() }}" class="text-right">Back</a></p>
</div>
