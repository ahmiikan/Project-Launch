...
@section('content')
    <div class="wt-jobdetails wt-tabsinfo">
        <div class="wt-tabscontenttitle">
            <h2>Gig Cancel Description</h2>
        </div>
        <div class="form-group">
            <form action="{{ route('gigCanceled', $gig->id) }}" method="GET">
                <label for="description">Reason</label>
                <textarea name="message" id="description" minlength="10" maxlength="255"
                          placeholder="Enter Gig Cancel Reason "
        ...
        <div class="wt-rightarea ">
            <a class="wt-btn" href="{{ url()->previous() }}"><i class="fa fa-arrow-left"></i>Back</a>
        </div>
