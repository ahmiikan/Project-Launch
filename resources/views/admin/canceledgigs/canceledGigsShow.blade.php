            ...
            <div class="wt-managejobcontent">
                ...
                <div class="wt-userlistinghold wt-featured wt-proposalitem">
                    ...
                    <figure class="wt-userlistingimg">
                        <img src="{{ asset('storage/images/gigimages/' . $canceledGigShow->image) }}"
                    ...
                    <div class="wt-userlistingvtwo">
                        <div class="wt-contenthead" style="margin: -25px; margin-left:6px">
                            <div class="wt-title">
                                <h2>{{ $canceledGigShow->freelancers->user->first_name." ". $canceledGigShow->freelancers->user->last_name }}</h2>
                            </div>
                            <div class="wt-title">
                ...
                <div>
                    <a href="{{ route('canceledGigs', $canceledGigShow->id) }}" class="wt-btn" style="margin-left: 70%"><i
